    ...
    """
        ...
        class RSDE(self.__class__):
            ...
            def sde(self, x, t, condition=None, mask=None, guide=False):
                ...
                #drift is the drift dt, diffusion is sigma dW, dx = drift dt + sigma dW, drift is of size [B]
                ...
                drift = drift.reshape(B,11,3)
                drift = torch.fft.irfft(drift, dim = 1, n = 21)
                drift = drift.reshape(B,63)
